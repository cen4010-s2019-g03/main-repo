...
if(empty($_POST['comment'])) {
	...
	$sql = "INSERT INTO Issue_Comments (Issue_ID, Comment_Text, Created_By, Insert_Date_Time, photo_file_name) VALUES ('" . $_POST['problemID'] . "', '" . $_POST['comment'] . "', '" . $_SESSION['znum'] . "', NOW(), " . (isset($uniq_id) ? "'" . $uniq_id . '.' . $file_ext . "'" : "NULL") . ")";
